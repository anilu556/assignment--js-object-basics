...
function firstNameKeyLastNameValue(xs){
  var object = { };
  //
  // var names = obj.split(" ")
  // var names1 = obj1.split(" ")
  // var names2 = obj2.split(" ")
  //
  // var first = names[0];
  // var second = names1[0];
  // var third = names2[0];
  //
  // object[first] = names[1];
  // object[second] = names1[1];
  // object[third] = names2[1];
  // console.log(object);
  for (var i = 0; i < arguments.length; i++) {
    var names = arguments[i].split(" ");
    object[names[0]] = names[1];
  }
